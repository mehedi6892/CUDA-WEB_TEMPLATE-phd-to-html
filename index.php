...
<head>
    ...
    <meta name ="description" content="An awesome portfolio template. You can easily design your portfolio website using this template.">
    <meta http-equiv="X-UA-Compatible" content="ie=edge">
    <title>An awesome portfolio template</title>
    <link rel="shortcut icon" href="resources/img/" type="image/x-icon">
    
    <!--GOOGLE FONTS-->
    <link href="https://font.googleapis.com/css?family=Titillium+Web:300,400,600,700&display=swap" rel="stylesheet"> 
            ...
            <div class="row">
                <div class="col span_1_of_4 box">
                    ...
                    <div class="social-link">
                        <ul>
                            <li><a href="https://www.facebook.com/mehedihshuvo98"><i class="fab fa-facebook-f"></i></a></li>
 ...
 <!-- HIDDEN LOAD more button -->
    ...
    <!-- START CONTACT SECTION -->
            <section class="contact-section" id="contact">
                ...
                <div class="row">
                    <form action="https://formspree.io/mehedihasan.cse.diu@gmail.com" method="POST">
                        <div class="row">
